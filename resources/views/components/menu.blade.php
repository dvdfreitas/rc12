    ...
    <nav class="flex justify-between bg-gray-900 text-white w-screen">
      <div class="px-5 xl:px-12 py-6 flex w-full items-center">
        ...
        <ul class="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
            <x-menu-link href="http://www.google.pt">Página inicial</x-menu-link>
            <x-menu-link href="http://www.aeg1.pt">Relatório</x-menu-link>
            <x-menu-link href="http://www.fcp.pt">Pap</x-menu-link>
            <x-menu-link>Sobre mim</x-menu-link>
        </ul>
        <!-- Header Icons -->
